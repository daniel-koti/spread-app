        ...
        <div className="flex flex-col h-full mt-4">
          ...
          <div className="mt-4 mx-6">
            <p className="text-sm inline text-gray-500">
              ...
              <Link className="text-orange-500 underline" href="/wallet">
                carteira
              </Link>{' '}
          ...
          <footer className="absolute bottom-5 px-4 w-full">
            <button
              onClick={onBuyTicket}
              className="bg-orange-500 px-4 flex items-center w-full justify-center h-[58px] rounded-[10px] hover:bg-orange-700 font-medium"
            >
              Finalizar compra
            </button>
          </footer>
